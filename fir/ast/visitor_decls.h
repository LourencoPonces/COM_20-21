...
#include <cdk/ast/visitor_decls.h>
  ...
  virtual void do_variable_definition_node(fir::variable_definition_node *const node, int lvl) = 0;
  ...
  void do_variable_definition_node(fir::variable_definition_node *const node, int lvl);
