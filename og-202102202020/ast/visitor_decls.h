...
#include <cdk/ast/visitor_decls.h>
  ...
  virtual void do_input_node(og::input_node *const node, int lvl) = 0;
  ...
  virtual void do_tuple_declaration_node(og::tuple_declaration_node *const node, int lvl) = 0;
  ...
  void do_input_node(og::input_node *const node, int lvl);
  ...
  void do_tuple_declaration_node(og::tuple_declaration_node *const node, int lvl);
