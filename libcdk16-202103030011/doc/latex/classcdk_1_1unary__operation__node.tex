...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{classcdk_1_1unary__operation__node__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=193pt]{classcdk_1_1unary__operation__node__coll__graph}
\end{center}
\end{figure}
