...
\begin{center}
\leavevmode
\includegraphics[width=348pt]{classcdk_1_1basic__postfix__emitter__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=193pt]{classcdk_1_1basic__postfix__emitter__coll__graph}
\end{center}
\end{figure}
