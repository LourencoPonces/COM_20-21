...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{classcdk_1_1binary__operation__node__inherit__graph}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=196pt]{classcdk_1_1binary__operation__node__coll__graph}
\end{center}
\end{figure}
